				...
				<div className="relative px-16 py-8">
					<div className="space-y-8 max-w-[1280px] mx-auto">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							{/* Left Column: Material Design & Design Tokens */}
							<motion.div
							...
							>
								...
								<div className="bg-[#1a1a1a] rounded-lg p-8">
									<div className="flex items-center gap-4 mb-4">
										{/* Inline SVG for Material Design Logo */}
										<svg
											className="w-10 h-10"
											viewBox="0 0 24 24"
											fill="#757575"
								...
								<div className="bg-[#1a1a1a] rounded-lg p-8">
									<h3 className="text-2xl font-bold text-tech-purple mb-4">
										設計標籤 (Design Tokens)
									</h3>
							...
							>
								<div className="bg-[#1a1a1a] rounded-lg p-8">
									<h3 className="text-2xl font-bold text-tech-green mb-6">
										實際應用流程
									</h3>
									<div className="space-y-6">
										...
										<div className="flex items-start gap-4">
											...
											<div>
												<h4 className="text-xl font-bold text-tech-green mb-2">
													制定基本規範
												</h4>
												<p className="text-gray-300 leading-relaxed">
													定義核心的設計原則，確定主要的顏色、字體、間距系統等基礎視覺元素（Design
													Tokens）。
												</p>
											</div>
										</div>
										...
										<div className="flex items-start gap-4">
											...
											<div>
												...
												<p className="text-gray-300 leading-relaxed">
													基於基本規範，開始建立可重複使用的 UI 元件（Atoms,
													Molecules），例如按鈕、輸入框、卡片等。
												</p>
											</div>
										</div>
										{/* Step 3 */}
